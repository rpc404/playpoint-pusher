...
const { setProfile, getAdmins, addAdmin, removeAdmin, getAdmin } = require("../api/controllers/Profile");
...
APIRouter.post("/profile", setProfile).get("/profile/:wallet",authorize, getAdmin)
